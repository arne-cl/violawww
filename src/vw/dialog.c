...
void messageDialog(DocViewInfo* dvip, char* msg, int type)
{
    ...
    XtSetArg(args[n], XmNmessageString, msg_xms);
    n++;
...
char* promptDialog(DocViewInfo* dvip, char *msg, char *defaultString) {
    ...
    okCallback[1].callback = cancelCallback[1].callback = applyCallback[1].callback = NULL;
    okCallback[1].closure = cancelCallback[1].closure = applyCallback[1].closure = NULL;
    ...
    if (defaultString) {
        ...
        XtSetArg(args[n], XmNtextString, default_xms);
        n++;
    }

    XtSetArg(args[n], XmNselectionLabelString, msg_xms);
    n++;
    XtSetArg(args[n], XmNapplyLabelString, apply_xms);
    n++;
    XtSetArg(args[n], XmNapplyCallback, applyCallback);
    n++;
    XtSetArg(args[n], XmNokCallback, okCallback);
    n++;
    XtSetArg(args[n], XmNcancelCallback, cancelCallback);
    n++;
    XtSetArg(args[n], XmNshadowThickness, 4);
    n++;
    XtSetArg(args[n], XmNshadowType, XmSHADOW_ETCHED_OUT);
...
char* questionDialog(DocViewInfo* dvip, char *question, char *defaultChoice, char *yesLabel, char *noLabel, char *cancelLabel) {
    ...
    XtSetArg(args[n], XmNokLabelString, yesLabel_xms);
    n++;
    XtSetArg(args[n], XmNokCallback, yesCallback);
    n++;
    ...
    if (noLabel) {
        ...
        XtSetArg(args[n], XmNcancelCallback, noCallback);
        n++;
        XtSetArg(args[n], XmNcancelLabelString, noLabel_xms);
        n++;
    ...
    if (cancelLabel) {
        ...
        XtSetArg(args[n], XmNhelpCallback, cancelCallback);
        n++;
        XtSetArg(args[n], XmNhelpLabelString, cancelLabel_xms);
        n++;
    ...
    if (defaultChoice) {
        if (cancelLabel && !strcmp(defaultChoice, cancelLabel)) {
            XtSetArg(args[n], XmNdefaultButtonType, XmDIALOG_HELP_BUTTON);
            n++;
        ...
        XtSetArg(args[n], XmNdefaultButtonType, XmDIALOG_NONE);
        n++;
    }

    question_xms = XmStringCreateLtoR(question, XmSTRING_DEFAULT_CHARSET);
    XtSetArg(args[n], XmNmessageString, question_xms);
    n++;
...
void questionDialogMH(char* arg[], int argc, void* clientData)
{
    ...
    result = questionDialog(dvip, arg[3], defaultChoice, yesLabel, noLabel, cancelLabel);
...
void printDialog(DocViewInfo* dvip, char* docName) {
    ...
    frame = XtVaCreateManagedWidget(
        ...
        XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM,
        XmNtopOffset, 4, XmNbottomOffset, 4, XmNleftOffset, 4, XmNrightOffset, 4, XmNmarginWidth, 4,
        XmNmarginHeight, 4, XmNshadowThickness, 0, NULL);
    ...
    label = XtVaCreateManagedWidget("Print", xmLabelWidgetClass, form, XmNalignment,
                                    XmALIGNMENT_BEGINNING, XmNtopAttachment, XmATTACH_FORM,
                                    XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
                                    XmATTACH_FORM, XmNlabelString, labelStringXMS, NULL);
    XmStringFree(labelStringXMS);

    commandLabel = XtVaCreateManagedWidget("Print Command:", xmLabelWidgetClass, form, XmNalignment,
                                           XmALIGNMENT_BEGINNING, XmNtopAttachment, XmATTACH_WIDGET,
                                           XmNtopWidget, label, XmNtopOffset, 6, XmNleftAttachment,
                                           XmATTACH_FORM, NULL);

    commandText = XtVaCreateManagedWidget(
        "commandText", xmTextFieldWidgetClass, form, XmNalignment, XmALIGNMENT_BEGINNING,
        XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, label, XmNtopOffset, 6, XmNleftAttachment,
        XmATTACH_WIDGET, XmNleftWidget, commandLabel, XmNrightAttachment, XmATTACH_FORM, XmNvalue,
        PRINT_COMMAND, NULL);

    optionLabel =
        XtVaCreateManagedWidget("Command-Line Options:", xmLabelWidgetClass, form, XmNalignment,
                                XmALIGNMENT_BEGINNING, XmNtopAttachment, XmATTACH_WIDGET,
                                XmNtopWidget, commandText, XmNleftAttachment, XmATTACH_FORM, NULL);
    ...
    optionText = XtVaCreateManagedWidget(
        "commandText", xmTextFieldWidgetClass, form, XmNalignment, XmALIGNMENT_BEGINNING,
        XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, commandText, XmNleftAttachment,
        XmATTACH_WIDGET, XmNleftWidget, optionLabel, XmNrightAttachment, XmATTACH_FORM, XmNvalue,
        optionDefault, NULL);

    printButton = XtVaCreateManagedWidget("Print", xmPushButtonWidgetClass, form, XmNtopAttachment,
                                          XmATTACH_WIDGET, XmNtopWidget, optionText, XmNtopOffset,
                                          6, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
                                          XmATTACH_POSITION, XmNrightPosition, 50, NULL);
    XtAddCallback(printButton, XmNactivateCallback, printYes, (XtPointer)&ps);

    cancelButton = XtVaCreateManagedWidget(
        "Cancel", xmPushButtonWidgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
        optionText, XmNtopOffset, 6, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 51,
        XmNrightAttachment, XmATTACH_FORM, NULL);
    XtAddCallback(cancelButton, XmNactivateCallback, printCancel, (XtPointer)&ps);
    ...
    if (ps.result) {
        ...
        if (printCommand) {
            ...
            sendMessage1N1str(dvip->violaDocViewObj, "printDoc", printString);
...
void openURLDialog(Widget widget, XtPointer clientData, XtPointer callData)
{
    Widget dlog, frame, form, label, protocolForm, protocolLabel, menu, optionMenu, protocolText,
        ...
        urlText, openButton, cancelButton, button;
    Arg args[12];
    int i, n = 0, done = 0;
    char labelString[256], optionDefault[256], printString[512];
    XEvent event;
    ...
    n = 0;
    XtSetArg(args[n], XmNhorizontalSpacing, 8);
    n++;
    XtSetArg(args[n], XmNverticalSpacing, 8);
    n++;
    XtSetArg(args[n], XmNfractionBase, 100);
    n++;
    XtSetArg(args[n], XmNshadowThickness, 4);
    ...
    labelStringXMS =
        XmStringCreateLtoR("Open Document via URL (Universal Resource Locator)", "largeFont");
    ...
    /* URL Protocol */
    protocolForm = XtVaCreateManagedWidget(
        "urlForm", xmFormWidgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget, label,
        XmNleftAttachment, XmATTACH_FORM, XmNhorizontalSpacing, 4, XmNverticalSpacing, 4,
        XmNshadowThickness, 2, XmNshadowType, XmSHADOW_ETCHED_IN, NULL);
    n = 0;
    menu = XmCreatePulldownMenu(protocolForm, "protocolMenu", args, n);
    for (i = 0; i < nprotocols; i++) {
        button = XmCreatePushButtonGadget(menu, protocols[i], NULL, 0);
        XtManageChild(button);
        XtAddCallback(button, XmNactivateCallback, setURLProtocol, (XtPointer)uds);
    }
    ...
    XtSetArg(args[n], XmNlabelString, protocolXMS);
    n++;
    optionMenu = XmCreateOptionMenu(protocolForm, "protocolOptions", args, n);
    XtManageChild(optionMenu);
    XmStringFree(protocolXMS);

    protocolText = XtVaCreateManagedWidget(
        "protocolText", xmTextFieldWidgetClass, protocolForm, XmNtopAttachment, XmATTACH_WIDGET,
        XmNtopWidget, optionMenu, XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment,
        XmATTACH_FORM, XmNrightAttachment, XmATTACH_OPPOSITE_WIDGET, XmNrightWidget, optionMenu,
        XmNrightOffset, 0, NULL);
    XtAddCallback(protocolText, XmNactivateCallback, setURLProtocol, (XtPointer)uds);
    XtAddCallback(protocolText, XmNlosingFocusCallback, setURLProtocol, (XtPointer)uds);
    uds->protocolText = protocolText;

    /* Machine Name */
    machineForm = XtVaCreateManagedWidget(
        "machineForm", xmFormWidgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
        label, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, protocolForm, XmNbottomAttachment,
        XmATTACH_OPPOSITE_WIDGET, XmNbottomWidget, protocolForm, XmNbottomOffset, 0,
        XmNhorizontalSpacing, 4, XmNverticalSpacing, 4, XmNshadowThickness, 2, XmNshadowType,
        XmSHADOW_ETCHED_IN, NULL);

    machineText = XtVaCreateManagedWidget("machineNameText", xmTextFieldWidgetClass, machineForm,
                                          XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
                                          XmATTACH_FORM, XmNbottomAttachment, XmATTACH_FORM, NULL);
    XtAddCallback(machineText, XmNactivateCallback, setURLMachine, (XtPointer)uds);
    XtAddCallback(machineText, XmNlosingFocusCallback, setURLMachine, (XtPointer)uds);
    uds->machineText = machineText;

    machineLabel = XtVaCreateManagedWidget(
        "Machine Name Component:", xmLabelWidgetClass, machineForm, XmNalignment,
        XmALIGNMENT_BEGINNING, XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment,
        XmATTACH_WIDGET, XmNbottomWidget, machineText, XmNleftAttachment, XmATTACH_FORM,
        XmNrightAttachment, XmATTACH_FORM, NULL);

    /* File Name */
    fileForm = XtVaCreateManagedWidget(
        "fileForm", xmFormWidgetClass, form, XmNhorizontalSpacing, 4, XmNverticalSpacing, 4,
        XmNshadowThickness, 2, XmNshadowType, XmSHADOW_ETCHED_IN, XmNtopAttachment, XmATTACH_WIDGET,
        XmNtopWidget, label, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, machineForm,
        XmNrightAttachment, XmATTACH_FORM, XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET,
        XmNbottomWidget, machineForm, XmNbottomOffset, 0, NULL);
    fileText = XtVaCreateManagedWidget("fileText", xmTextFieldWidgetClass, fileForm,
                                       XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
                                       XmATTACH_FORM, XmNbottomAttachment, XmATTACH_FORM, NULL);
    XtAddCallback(fileText, XmNactivateCallback, setURLFile, (XtPointer)uds);
    XtAddCallback(fileText, XmNlosingFocusCallback, setURLFile, (XtPointer)uds);

    fileLabel = XtVaCreateManagedWidget(
        "File Name Component:", xmLabelWidgetClass, fileForm, XmNalignment, XmALIGNMENT_BEGINNING,
        XmNtopAttachment, XmATTACH_FORM, XmNbottomAttachment, XmATTACH_WIDGET, XmNbottomWidget,
        fileText, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM, NULL);

    /* URL Text */
    urlForm = XtVaCreateManagedWidget("urlForm", xmFormWidgetClass, form, XmNhorizontalSpacing, 4,
                                      XmNverticalSpacing, 4, XmNshadowThickness, 2, XmNshadowType,
                                      XmSHADOW_ETCHED_IN, XmNtopAttachment, XmATTACH_WIDGET,
                                      XmNtopWidget, protocolForm, XmNleftAttachment, XmATTACH_FORM,
                                      XmNrightAttachment, XmATTACH_FORM, NULL);
    urlLabel = XtVaCreateManagedWidget(
        "Complete URL:   Protocol :// MachineName / FileName", xmLabelWidgetClass, urlForm,
        XmNalignment, XmALIGNMENT_BEGINNING, XmNtopAttachment, XmATTACH_FORM, XmNleftAttachment,
        XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM, NULL);
    urlText = XtVaCreateManagedWidget("urlText", xmTextFieldWidgetClass, urlForm, XmNtopAttachment,
                                      XmATTACH_WIDGET, XmNtopWidget, urlLabel, XmNleftAttachment,
    ...
    /* Open Button */
    openButton = XtVaCreateManagedWidget(
        "Open URL", xmPushButtonWidgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
        urlForm, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment, XmATTACH_POSITION,
        XmNrightPosition, 50, XmNbottomAttachment, XmATTACH_FORM, NULL);
    XtAddCallback(openButton, XmNactivateCallback, openURL, (XtPointer)uds);

    cancelButton = XtVaCreateManagedWidget(
        "Cancel", xmPushButtonWidgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
        urlForm, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, openButton, XmNrightAttachment,
        XmATTACH_FORM, XmNbottomAttachment, XmATTACH_FORM, NULL);
...
void openSimpleURLDialog(Widget widget, XtPointer clientData, XtPointer callData)
{
    ...
    urlText = XtVaCreateManagedWidget("urlText", xmTextFieldWidgetClass, form, XmNtopAttachment,
                                      XmATTACH_WIDGET, XmNtopWidget, label, XmNleftAttachment,
                                      XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM, XmNcolumns,
                                      50, NULL);
    XtAddCallback(urlText, XmNactivateCallback, openURL, (XtPointer)uds);
    uds->urlText = urlText;
    ...
    openButton = XtVaCreateManagedWidget(
        "Open URL", xmPushButtonWidgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
        urlText, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment, XmATTACH_POSITION,
        XmNrightPosition, 33, XmNbottomAttachment, XmATTACH_FORM, NULL);
    XtAddCallback(openButton, XmNactivateCallback, openURL, (XtPointer)uds);

    /* Clear Button */
    clearButton = XtVaCreateManagedWidget(
        "Clear", xmPushButtonWidgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
        urlText, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, openButton, XmNrightAttachment,
        XmATTACH_POSITION, XmNrightPosition, 66, XmNbottomAttachment, XmATTACH_FORM, NULL);
    XtAddCallback(clearButton, XmNactivateCallback, clearURL, (XtPointer)uds);

    /* Cancel Button */
    cancelButton = XtVaCreateManagedWidget(
        "Cancel", xmPushButtonWidgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
        urlText, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, clearButton, XmNrightAttachment,
        XmATTACH_FORM, XmNbottomAttachment, XmATTACH_FORM, NULL);
    XtAddCallback(cancelButton, XmNactivateCallback, cancelURL, (XtPointer)uds);
...
void simpleOpenURLDialog(Widget widget, XtPointer clientData, XtPointer callData)
{
    ...
    char* url = promptDialog(dvi, "Enter the URL you wish to open:", dvi->URL);
...
char* fileSelectionDialog(DocViewInfo* dvi, char *message, char *helpMsg) {
    ...
    XtAddCallback(button, XmNactivateCallback, fileCancelCB, (XtPointer)&fss);
    ...
    if (helpMsg) {
        ...
        XtAddCallback(button, XmNactivateCallback, fileHelpCB, (XtPointer)&cd);
    } else {
        XtUnmanageChild(button);
    }
...
char* openSimpleLineEntryDialog(DocViewInfo* dvi, char *dialogLabel, char *defaultAns, void (*okCB)()) {
    ...
    lineText = XtVaCreateManagedWidget("lineText", xmTextFieldWidgetClass, form, XmNtopAttachment,
                                       XmATTACH_WIDGET, XmNtopWidget, label, XmNleftAttachment,
                                       XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM, XmNvalue,
                                       defaultAns, XmNcolumns, 50, NULL);
    /*     defaultStringXMS = XmStringCreateLtoR(defaultAns, "largeFont");
        XmStringFree(defaultStringXMS);
    */
    XtAddCallback(lineText, XmNactivateCallback, LineEntry_okCB, (XtPointer)lds);
    lds->lineText = lineText;

    /* Ok Button */
    LineEntry_okButton = XtVaCreateManagedWidget(
        "OK", xmPushButtonWidgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
        lineText, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment, XmATTACH_POSITION,
        XmNrightPosition, 33, XmNbottomAttachment, XmATTACH_FORM, NULL);
    XtAddCallback(LineEntry_okButton, XmNactivateCallback, LineEntry_okCB, (XtPointer)lds);

    /* Clear Button */
    LineEntry_clearButton = XtVaCreateManagedWidget(
        "Clear", xmPushButtonWidgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
        lineText, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, LineEntry_okButton,
        XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 66, XmNbottomAttachment,
        XmATTACH_FORM, NULL);
    XtAddCallback(LineEntry_clearButton, XmNactivateCallback, LineEntry_clearCB, (XtPointer)lds);

    /* Cancel Button */
    LineEntry_cancelButton = XtVaCreateManagedWidget(
        "Cancel", xmPushButtonWidgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
        lineText, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, LineEntry_clearButton,

...
XtPointer clientData, callData;
{
    Widget shell, titleFrame, title, helpLabel, form, frame, commandFrame, commandLabel,
        ...
        sendMailB, saveAsB, closeB, textEditor;
    Pixel bg;
    ...
    shell = XtVaAppCreateShell("Mail Editor", "Viola", applicationShellWidgetClass,
                               XtDisplay(parentDVI->shell), XmNborderWidth, 2, XmNiconPixmap, icon,
                               NULL);

    form = XtVaCreateManagedWidget("form", xmFormWidgetClass, shell, XmNhorizontalSpacing,
                                   FORM_SPACING, XmNverticalSpacing, 6, NULL);

    titleFrame =
        XtVaCreateManagedWidget("titleFrame", xmFrameWidgetClass, form, XmNtopAttachment,
                                XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
                                XmATTACH_FORM, XmNmarginHeight, 2, XmNmarginWidth, 2, NULL);
    ...
    commandFrame = XtVaCreateManagedWidget(
        "commandFrame", xmFormWidgetClass, form, XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
        titleFrame, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM,
    ...
    commandText = XtVaCreateManagedWidget(
        "mailCommandText", xmTextFieldWidgetClass, commandFrame, XmNtopAttachment, XmATTACH_FORM,
        XmNtopOffset, 6, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 25,
        XmNrightAttachment, XmATTACH_FORM, XmNvalue, MAIL_COMMAND, NULL);
    commandLabel = XtVaCreateManagedWidget(
        "EMail Program:", xmLabelWidgetClass, commandFrame, XmNtopAttachment, XmATTACH_FORM,
        XmNtopOffset, 6, XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET, XmNbottomWidget,
        commandText, XmNbottomOffset, 0, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
        XmATTACH_WIDGET, XmNrightWidget, commandText, XmNalignment, XmALIGNMENT_BEGINNING, NULL);
    addressText = XtVaCreateManagedWidget(
        "mailAddressText", xmTextFieldWidgetClass, commandFrame, XmNtopAttachment, XmATTACH_WIDGET,
        XmNtopWidget, commandText, XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 25,
        XmNrightAttachment, XmATTACH_FORM, XmNvalue, DEVELOPER_ADDRESS, NULL);
    addressLabel = XtVaCreateManagedWidget(
        "Address:", xmLabelWidgetClass, commandFrame, XmNtopAttachment, XmATTACH_WIDGET,
        XmNtopWidget, commandText, XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET, XmNbottomWidget,
        addressText, XmNbottomOffset, 0, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
        XmATTACH_WIDGET, XmNrightWidget, addressText, XmNalignment, XmALIGNMENT_BEGINNING, NULL);
    subjectText = XtVaCreateManagedWidget(
        "mailSubjectText", xmTextFieldWidgetClass, commandFrame, XmNtopAttachment, XmATTACH_WIDGET,
        XmNtopWidget, addressText, XmNbottomAttachment, XmATTACH_WIDGET, XmNbottomOffset, 6,
        XmNleftAttachment, XmATTACH_POSITION, XmNleftPosition, 25, XmNrightAttachment,
        XmATTACH_FORM, XmNvalue, "-s \"subject\"", NULL);
    subjectLabel = XtVaCreateManagedWidget(
        "Subject:", xmLabelWidgetClass, commandFrame, XmNtopAttachment, XmATTACH_WIDGET,
        XmNtopWidget, addressText, XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET, XmNbottomWidget,
        subjectText, XmNbottomOffset, 0, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
        XmATTACH_WIDGET, XmNrightWidget, subjectText, XmNalignment, XmALIGNMENT_BEGINNING, NULL);
    ...
    buttonBox = XtVaCreateManagedWidget(
        ...
        XmATTACH_FORM, XmNrightAttachment, XmATTACH_FORM, XmNfractionBase, 4, NULL);

    sendMailB = XtVaCreateManagedWidget(
        "Send Mail", xmPushButtonWidgetClass, buttonBox, XmNtopAttachment, XmATTACH_FORM,
        XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_FORM, XmNrightAttachment,
        XmATTACH_POSITION, XmNrightPosition, 1, NULL);
    XtAddCallback(sendMailB, XmNactivateCallback, sendMailCB, (XtPointer)ms);

    insertFileB = XtVaCreateManagedWidget(
        "Insert File...", xmPushButtonWidgetClass, buttonBox, XmNtopAttachment, XmATTACH_FORM,
        XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget,
        sendMailB, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 2, NULL);
    XtAddCallback(insertFileB, XmNactivateCallback, mailLoadFileCB, (XtPointer)ms);

    saveAsB = XtVaCreateManagedWidget(
        "Save As...", xmPushButtonWidgetClass, buttonBox, XmNtopAttachment, XmATTACH_FORM,
        XmNbottomAttachment, XmATTACH_FORM, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget,
        insertFileB, XmNrightAttachment, XmATTACH_POSITION, XmNrightPosition, 3, NULL);
    XtAddCallback(saveAsB, XmNactivateCallback, mailSaveAsCB, (XtPointer)ms);

    closeB = XtVaCreateManagedWidget("Close", xmPushButtonWidgetClass, buttonBox, XmNtopAttachment,
                                     XmATTACH_FORM, XmNbottomAttachment, XmATTACH_FORM,
                                     XmNrightAttachment, XmATTACH_FORM, XmNleftAttachment,
                                     XmATTACH_WIDGET, XmNleftWidget, saveAsB, NULL);
    XtAddCallback(closeB, XmNactivateCallback, closeMailEditorCB, (XtPointer)ms);

    helpLabel = XtVaCreateManagedWidget("helpLabel", xmLabelWidgetClass, form, XmNbottomAttachment,
                                        XmATTACH_WIDGET, XmNbottomWidget, buttonBox,
                                        XmNrightAttachment, XmATTACH_FORM, XmNleftAttachment,
                                        XmATTACH_FORM, XmNalignment, XmALIGNMENT_BEGINNING,
                                        XmNrecomputeSize, FALSE, XmNborderWidth, 1, NULL);
    setHelp(title, helpLabel,
            "Your comments will help us make Viola better for YOU.   Thank you for your time!");
    setHelp(commandLabel, helpLabel,
            "This is the program that Viola will use to send your letter.");
    ...
    setHelp(insertFileB, helpLabel,
            "Read a text file from the local disk and insert it into the letter.");
    setHelp(saveAsB, helpLabel, "Save the contents of the mail editor to a local file.");
    setHelp(sendMailB, helpLabel,
            "Send letter using the mail command, email address, and the subject specified above.");
    ...
    n++;
    XtSetArg(args[n], XmNtopWidget, commandFrame);
    n++;
    XtSetArg(args[n], XmNbottomAttachment, XmATTACH_WIDGET);
    n++;
    XtSetArg(args[n], XmNbottomWidget, helpLabel);
    n++;
    ...
    n++;
    XtSetArg(args[n], XmNresizeWidth, TRUE);
    n++;
    ...
    XtAddCallback(textEditor, XmNvalueChangedCallback, mailValueChangedCB,
                  (XtPointer)localDocViewInfo);
...
XtPointer clientData, callData;
{
    ...
    if (dvi->editorDataChanged) {
        dvi->editorDataChanged = 0;
        XtAddCallback(dvi->textEditor, XmNvalueChangedCallback, mailValueChangedCB, (XtPointer)dvi);
    }
}
...
XtPointer clientData, callData;
{
    ...
    answer = questionDialog(dvi, dlogMessage, "OK, Send Letter", "OK, Send Letter", "Cancel", NULL);
...
XtPointer clientData, callData;
{
    ...
    fileName = fileSelectionDialog(dvi, "Select the file you wish to insert into your letter:",
                                   "The contents of the file you select will be\ninserted into "
                                   "your letter at the text cursor.");

    newText = readFile(fileName, dvi);
    XmTextInsert(ms->letterText, XmTextGetInsertionPosition(ms->letterText), newText);
    XtFree(newText);
    XtFree(fileName);
}

/*
 * HTML_xbm_script.v - Inline XBM image handler
 *
 * Handles XBM (X BitMap) images with inline data provided via <FIGDATA>.
 * XBM is a monochrome bitmap format using C source code syntax.
 *
 * Features:
 *   - Parses XBM C code from FIGDATA content
 ...
 *
 * Used when: <FIGURE TYPE="xbm"><FIGDATA>...XBM data...</FIGDATA></FIGURE>
 */
	switch (arg[0]) {
	case "D":
		set("label", get("label"));

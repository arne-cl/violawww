...
long kbf_dump();
long kbf_refresh();
long kbf_beginning_of_line();
long kbf_backward_char();
long kbf_delete_char();
long kbf_end_of_line();
long kbf_forward_char();
long kbf_delete_backward_char();
long kbf_join_line();
long kbf_kill_line();
long kbf_open_line_below();
long kbf_next_line();
long kbf_open_line();
long kbf_previous_line();
long kbf_scroll_up_line();
long kbf_delete_line();
long kbf_scroll_up();
long kbf_scroll_down();
long kbf_scroll_up();
long kbf_insert_yank();
long kbf_scroll_down_line();
long kbf_delete_backward_char();
long kbf_esc_prefix();
long kbf_newline();
long kbf_ident();
long kbf_useFont_context();
long kbf_useFont_fixed();
long kbf_useFont_normal();
long kbf_useFont_normal_large();
long kbf_useFont_normal_largest();
long kbf_useFont_bold();
long kbf_useFont_bold_large();
long kbf_useFont_bold_largest();

...
static attr a_attr[] = {/* Should be ID */
                        {"HREF"}, {"NAME"}, {"REL"}, {"REV"}, {"TITLE"}, {"TYPE"}, {"URN"}, {0}};
...
static attr entry_attr[] = {{"HREF"}, {"NAME"}, {"TYPE"}, {0}};

static attr example_attr[] = {{"HREF"}, {"BORDER"}, {0}};

static attr figa_attr[] = {{"AREA"}, {"HREF"}, {0}};

static attr figure_attr[] = {{"FOLD"},     {"HEIGHT"},   {"ISMAP"},    {"LABEL"},
                             {"MAXWIDTH"}, {"MAYDELAY"}, {"MINWIDTH"}, {"SRC"},
                             {"TYPE"},     {"WIDTH"},    {0}};

static attr form_attr[] = {{"ACTION"}, {"ENVVAR"},   {"FOLD"}, {"LABEL"}, {"MAXWIDTH"},
                           {"METHOD"}, {"MINWIDTH"}, {"NAME"}, {0}};

static attr graphics_attr[] = {{"HEIGHT"}, {"ID"}, {"NAME"}, {"WIDTH"}, {0}};

static attr header_attr[] = {{"ALIGN"}, {"ID"}, {"NAME"}, {0}};
...
static attr isindex_attr[] = {{"ACTION"}, {0}};
...
static attr scale_attr[] = {{"SC"}, {"X"}, {"Y"}, {"Z"}, {0}};
...
static attr p_attr[] = {{"ALIGN"}, {"FOLD"},     {"ID"},       {"INDEX"}, {"LABEL"},
                        {"LANG"},  {"MAXWIDTH"}, {"MINWIDTH"}, {"STYLE"}, {0}};

static attr pre_attr[] = {{"WIDTH"}, {0}};
...
static attr table_attr[] = {{"BORDER"}, {"COMPACT"},  {"FOLD"},     {"ID"}, {"INDEX"},
                            {"LABEL"},  {"MAXWIDTH"}, {"MINWIDTH"}, {0}};

static attr tcap_attr[] = {{"ALIGN"}, {"TOP"}, {0}};

static attr td_attr[] = {{"ALIGN"}, {"COLSPAN"}, {"ROWSPAN"}, {0}};

static attr textarea_attr[] = {{"COL"}, {"COLS"}, {"NAME"}, {"ROW"}, {"ROWS"}, {"SIZE"}, {0}};

static attr th_attr[] = {{"ALIGN"}, {"COLSPAN"}, {"ROWSPAN"}, {0}};

static attr ul_attr[] = {{"COMPACT"}, {"FOLD"}, {"LABEL"}, {"MAXWIDTH"}, {"MINWIDTH"}, {0}};

static attr vobjf_attr[] = {{"ARG"}, {"HREF"}, {"MAXWIDTH"}, {"MINWIDTH"}, {"NAME"}, {0}};

static attr xmp_attr[] = {{"BORDER"},   {"FOLD"},     {"HREF"}, {"LABEL"},
                          {"MAXWIDTH"}, {"MINWIDTH"}, {"NAME"}, {0}};

/* messy */
static attr shared_list_attr[] = {
    {"COMPACT"}, {0} /* Terminate list */
};

#define dd_dt_validSubElementsCount 82
static HTMLElement dd_dt_validSubElements[] = {
    HTML_A,        HTML_BASE,    HTML_ADDRESS,  HTML_AUTHOR,    HTML_B,       HTML_BLOCKQUOTE,
    HTML_BODY,     HTML_BOLD,    HTML_BR,       HTML_CAUTION,   HTML_CHANGED, HTML_CITE,
    HTML_CMD,      HTML_CODE,    HTML_COMMENT,  HTML_DFN,       HTML_DIR,     HTML_DL,
    HTML_DLC,      HTML_EM,      HTML_EMPH,     HTML_ENTRY,     HTML_EXAMPLE, HTML_FIGURE,
    HTML_FOOTNOTE, HTML_FORM,    HTML_GRAPHICS, HTML_H1,        HTML_H2,      HTML_H3,
    HTML_H4,       HTML_H5,      HTML_H6,       HTML_H7,        HTML_HEAD,    HTML_HPANE,
    HTML_HR,       HTML_HTML,    HTML_I,        HTML_IMAGE,     HTML_IMG,     HTML_INPUT,
    HTML_INSERT,   HTML_ISINDEX, HTML_ITALIC,   HTML_KBD,       HTML_KEY,     HTML_L,
    HTML_LABEL,    HTML_LINK,    HTML_LISTING,  HTML_LIT,       HTML_MENU,    HTML_NEXTID,
    HTML_OL,       HTML_P,       HTML_PLAIN,    HTML_PLAINTEXT, HTML_PRE,     HTML_QUOTE,
    HTML_SAMP,     HTML_SCREEN,  HTML_SECTION,  HTML_SELECT,    HTML_STRONG,  HTML_SUB,
    HTML_SUP,      HTML_TABLE,   HTML_TBL,      HTML_TEXTAREA,  HTML_TITLE,   HTML_TT,
    HTML_U,        HTML_UL,      HTML_UNDER,    HTML_VAR,       HTML_VINSERT, HTML_VOBJF,
    HTML_VR,       HTML_VSCRIPT, HTML_VVIEW,    HTML_XMP,
};
...
static HTMLElement style_validSubElements[] = {
    HTML_A,   HTML_B,      HTML_BOLD, HTML_CMD,    HTML_EM,  HTML_EMPH,
    HTML_I,   HTML_IMAGE,  HTML_IMG,  HTML_ITALIC, HTML_KBD, HTML_KEY,
    HTML_LIT, HTML_STRONG, HTML_SUB,  HTML_SUP,    HTML_TT,  HTML_U,
};
...
static HTMLElement ol_ul_validSubElements[] = {
    HTML_A,   HTML_B,    HTML_BOLD,     HTML_BR, HTML_CITE,  HTML_CMD, HTML_CODE,    HTML_DFN,
    HTML_EM,  HTML_EMPH, HTML_FOOTNOTE, HTML_I,  HTML_IMAGE, HTML_IMG, HTML_ITALIC,  HTML_KBD,
    HTML_KEY, HTML_L,    HTML_LABEL,    HTML_LI, HTML_LINK,  HTML_P,   HTML_SAMP,    HTML_STRONG,
...
static HTMLElement p_validSubElements[] = {
    ...
    HTML_IMG,   HTML_INPUT, HTML_ITALIC, HTML_KBD,      HTML_KEY,     HTML_L,
    HTML_LABEL, HTML_LINK,  HTML_SAMP,   HTML_STRONG,   HTML_SUB,     HTML_SUP,
    HTML_TT,    HTML_U,     HTML_UNDER,  HTML_VAR,      HTML_VINSERT,
};
...
static HTMLElement option_validSubElements[] = {
    HTML_A,   HTML_B,    HTML_BOLD,     HTML_BR,   HTML_CITE,    HTML_CMD,    HTML_CODE,   HTML_DFN,
    HTML_EM,  HTML_EMPH, HTML_FOOTNOTE, HTML_I,    HTML_IMAGE,   HTML_IMG,    HTML_ITALIC, HTML_KBD,
    HTML_KEY, HTML_L,    HTML_LABEL,    HTML_LINK, HTML_SAMP,    HTML_STRONG, HTML_SUB,    HTML_SUP,
    HTML_TT,  HTML_U,    HTML_UNDER,    HTML_VAR,  HTML_VINSERT,
};

#define th_validSubElementsCount 34
static HTMLElement th_validSubElements[] = {
    HTML_A,     HTML_B,    HTML_BOLD,   HTML_BR,    HTML_CITE,   HTML_CMD,      HTML_CODE,
    HTML_DFN,   HTML_DIR,  HTML_DL,     HTML_EM,    HTML_EMPH,   HTML_FOOTNOTE, HTML_I,
    HTML_IMAGE, HTML_IMG,  HTML_ITALIC, HTML_KBD,   HTML_KEY,    HTML_L,        HTML_LABEL,
    HTML_LINK,  HTML_MENU, HTML_OL,     HTML_SAMP,  HTML_STRONG, HTML_SUB,      HTML_SUP,
...
static HTMLElement loose_validSubElements[] = {
    ...
    HTML_LABEL,    HTML_LINK,    HTML_LISTING,  HTML_LIT,       HTML_MENU,     HTML_NEXTID,
    HTML_OL,       HTML_P,       HTML_PLAIN,    HTML_PLAINTEXT, HTML_PRE,      HTML_QUOTE,
    HTML_SAMP,     HTML_SCREEN,  HTML_SECTION,  HTML_SELECT,    HTML_SECURITY, HTML_STRONG,
    HTML_SUB,      HTML_SUP,     HTML_TABLE,    HTML_TBL,       HTML_TEXTAREA, HTML_TITLE,
    HTML_TT,       HTML_U,       HTML_UL,       HTML_UNDER,     HTML_VAR,      HTML_VINSERT,
    HTML_VOBJ,     HTML_VOBJF,   HTML_VR,       HTML_VSCRIPT,   HTML_VVIEW,    HTML_XMP};
...
static HTTag tags[] = {
    ...
    {"BR", p_attr, HTML_P_ATTRIBUTES, SGML_MIXED, p_validSubElements, p_validSubElementsCount},
    ...
    {"DD", no_attr, 0, SGML_MIXED, dd_dt_validSubElements, dd_dt_validSubElementsCount},
    ...
    {"DT", no_attr, 0, SGML_MIXED, dd_dt_validSubElements, dd_dt_validSubElementsCount},
    ...
    {"H1", header_attr, HTML_HEADER_ATTRIBUTES, SGML_MIXED, p_validSubElements,
     p_validSubElementsCount},
    {"H2", header_attr, HTML_HEADER_ATTRIBUTES, SGML_MIXED, p_validSubElements,
     p_validSubElementsCount},
    {"H3", header_attr, HTML_HEADER_ATTRIBUTES, SGML_MIXED, p_validSubElements,
     p_validSubElementsCount},
    {"H4", header_attr, HTML_HEADER_ATTRIBUTES, SGML_MIXED, p_validSubElements,
     p_validSubElementsCount},
    {"H5", header_attr, HTML_HEADER_ATTRIBUTES, SGML_MIXED, p_validSubElements,
     p_validSubElementsCount},
    {"H6", header_attr, HTML_HEADER_ATTRIBUTES, SGML_MIXED, p_validSubElements,
     p_validSubElementsCount},
    {"H7", header_attr, HTML_HEADER_ATTRIBUTES, SGML_MIXED, p_validSubElements,
     p_validSubElementsCount},
    ...
    {"I", no_attr, 0, SGML_MIXED, style_validSubElements, style_validSubElementsCount},
    ...
    {"ITALIC", no_attr, 0, SGML_MIXED, style_validSubElements, style_validSubElementsCount},
    ...
    {"OLC", ol_attr, HTML_OL_ATTRIBUTES, SGML_MIXED, ol_ul_validSubElements,
     ol_ul_validSubElementsCount},
    {"OPTION", option_attr, HTML_OPTION_ATTRIBUTES, SGML_MIXED, option_validSubElements,
     option_validSubElementsCount},
    {"OVAL", oval_attr, HTML_OVAL_ATTRIBUTES, SGML_MIXED, 0, 0},
    {"OVER", no_attr, 0, SGML_EMPTY, 0, 0},
    {"P", p_attr, HTML_P_ATTRIBUTES, SGML_MIXED, p_validSubElements, p_validSubElementsCount},
    ...
    {"TT", no_attr, 0, SGML_MIXED, style_validSubElements, style_validSubElementsCount},
    {"U", no_attr, 0, SGML_MIXED, style_validSubElements, style_validSubElementsCount},
    {"UL", ul_attr, HTML_UL_ATTRIBUTES, SGML_MIXED, ol_ul_validSubElements,
     ol_ul_validSubElementsCount},
    {"ULC", ul_attr, HTML_UL_ATTRIBUTES, SGML_MIXED, ol_ul_validSubElements,
     ol_ul_validSubElementsCount},
    {"UNDER", no_attr, 0, SGML_MIXED, style_validSubElements, style_validSubElementsCount},
    {"VAR", no_attr, 0, SGML_MIXED, 0, 0},
    {"VINSERT", no_attr, 0, SGML_LITTERAL, 0, 0},
    {"VOBJ", no_attr, 0, SGML_MIXED, vobj_validSubElements, vobj_validSubElementsCount},
...
PUBLIC void HTStartAnchor ARGS3(HTStructured*, obj, CONST char*, name, CONST char*, href) {
    ...
    (*obj->isa->start_element)(obj, HTML_A, present, value, &HTML_dtd.tags[HTML_A] /*PYW*/);
}

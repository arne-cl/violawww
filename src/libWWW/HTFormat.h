...
typedef HTStream* HTConverter PARAMS((HTPresentation * pres, HTParentAnchor* anchor,
                                      HTStream* sink));
 ...
 */
extern HTStream* HTStreamStack PARAMS((HTFormat format_in, HTFormat format_out,
                                       HTStream* stream_out, HTParentAnchor* anchor));
 ...
 */
extern float HTStackValue PARAMS((HTFormat format_in, HTFormat rep_out, float initial_value,
                                  long int length));
 ...
 */
extern void HTCopy PARAMS((int file_number, HTStream* sink));
 ...
 */
extern int HTParseSocket PARAMS((HTFormat format_in, HTFormat format_out, HTParentAnchor* anchor,
 ...
 */
extern int HTParseFile PARAMS((HTFormat format_in, HTFormat format_out, HTParentAnchor* anchor,

...
extern HText* HText_new2 PARAMS((HTParentAnchor * anchor, HTStream* output_stream));

extern HText* HText_new3 PARAMS((HTParentAnchor * anchor, HTStream* output_stream,

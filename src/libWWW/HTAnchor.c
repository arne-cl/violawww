...
HTAnchor* HTAnchor_findAddress ARGS1(const char*, address) {
    ...
    if (*tag) {
        char* docAddress =
            HTParse(address, "", PARSE_ACCESS | PARSE_HOST | PARSE_PATH | PARSE_PUNCTUATION);
...
PUBLIC HTParentAnchor* HTAnchor_parent ARGS1(HTAnchor*, me) { return me ? me->parent : NULL; }
...
HTFormat HTAnchor_format ARGS1(HTParentAnchor*, me) { return me ? me->format : NULL; }
...
BOOL HTAnchor_isIndex ARGS1(HTParentAnchor*, me) { return me ? me->isIndex : NO; }
...
HTAnchor* HTAnchor_followMainLink ARGS1(HTAnchor*, me) { return me->mainLink.dest; }
...
PUBLIC void* HTAnchor_protocol ARGS1(HTParentAnchor*, me) { return me->protocol; }
...
PUBLIC char* HTAnchor_physical ARGS1(HTParentAnchor*, me) { return me->physical; }

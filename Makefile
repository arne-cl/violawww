...
X11_PKGS = x11 xext xmu xt sm ice xrender
...
# macOS-specific: Objective-C sound library and UDP sync
ifeq ($(UNAME_S),Darwin)
VIOLA_OBJS += $(VIOLA_DIR)/slib_darwin.o $(VIOLA_DIR)/sync_multicast.o
endif
